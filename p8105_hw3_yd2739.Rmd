...
excellent_plot = excellent_df|>
  ...
  labs(title = "Average Data Value of 'Excellent' Responses Over Time", x = "Year", y = "Average Data Value") 
excellent_plot
```
...
NY_distribution_boxplot = NY_distribution_df|>
  ...
  facet_grid(. ~ year)+
  theme(axis.text.x = element_text(angle = 90, vjust = 1, hjust=1))+
  labs(title = "Distribution of Data Value of Response Among NY", x = "Year", y = "Average Data Value") 
...
```{r}
grouped_24hr_median_plot = merged_acc_info_df|>
